...
public class ProductServiceImplTest {
	...
	public void addProductTest() throws ProductNotFoundException{
		...
		Product product=new Product(1,"laddu",450.02,"this is my first sweet",true,"C:\\Users\\Win10\\Pictures\\Screenshots\\killua.png",category);
	...
	public void getAllProductTest() throws ProductNotFoundException{
		...
		Category category=new Category(101,"firstcat");
		Product product1=new Product(1,"laddu",450.02,"this is my first sweet",true,"C:\\Users\\Win10\\Pictures\\Screenshots\\killua.png",category);
		Product product2=new Product(2,"burfi",678.39,"this is my second sweet",true,"C:\\Users\\Win10\\Pictures\\Screenshots\\killua.png",category);
	...
	public void updateProductTest() throws ProductNotFoundException{
		...
		Category category=new Category(101,"firstcat");
		Product product=new Product(1,"laddu",450.02,"this is my first sweet",true,"C:\\Users\\Win10\\Pictures\\Screenshots\\killua.png",category);
		Product updated_product=new Product(1,"burfi",672.8,"this is my updated sweet",true,"C:\\Users\\Win10\\Pictures\\Screenshots\\killua.png",category);
